...
export default function ModalEditAddress({
  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{t(language, "editAddressTitle")}</DialogTitle>
          <DialogDescription>{t(language, "editAddressDesc")}</DialogDescription>
        </DialogHeader>
              ...
              <Form className="w-full">
                ...
                <div className="flex w-full gap-4 flex-wrap mb-4 ">
                  <div className="flex flex-col gap-4 sm:w-[320px] grow">
                    <label htmlFor="name">{t(language, "firstNameLabel")}</label>
                    <Field
                      type="text"
                      name="firstName"
                      className={cn(
                  ...
                  <div className="flex flex-col gap-4 sm:w-[320px] grow">
                    <label htmlFor="lastName">{t(language, "lastNameLabel")}</label>
                    <Field
                      type="text"
                      name="lastName"
                      className={cn(
                ...
                <div className="flex w-full gap-4 flex-wrap mb-4">
                  <div className="flex flex-col gap-4 sm:w-[320px] grow">
                    <label htmlFor="city">{t(language, "cityLabel")}</label>
                    <Field
                      type="text"
                      name="city"
                      className={cn(
                  ...
                  <div className="flex flex-col gap-4 sm:w-[320px] grow">
                    <label htmlFor="country">{t(language, "countryLabel")}</label>
                    <Field
                      type="text"
                      name="country"
                      className={cn(
                ...
                <div className="flex w-full gap-4 flex-wrap mb-4">
                  <div className="flex flex-col gap-4 sm:w-[320px] grow">
                    <label htmlFor="city">{t(language, "zipCodeLabel")}</label>
                    <Field
                      type="text"
                      name="zipCode"
                      className={cn(
                  ...
                  <div className="flex flex-col gap-4 sm:w-[320px] grow">
                    <label htmlFor="address">{t(language, "addressFieldLabel")}</label>
                    <Field
                      type="text"
                      name="address"
                      className={cn(
                ...
                <div className="flex w-full gap-4 flex-wrap mb-4">
                  <div className="flex flex-col gap-4 sm:w-[320px] grow">
                    <label htmlFor="address">{t(language, "stateProvinceLabel")}</label>
                    <Field
                      type="text"
                      name="state"
                      className={cn(
                ...
                <div className="flex sm:w-full">
                  ...
                  >
                    <Send />
                    <span className="text-xl">{t(language, "saveButton")} </span>
                  </Button>
                </div>
              </Form>
            )}
