  ...
  return (
    <section className="min-h-screen pb-32 sm:pb-8 xl:pb-8">
      <Container>
        ...
        <div className="xl:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 px-4 py-3 z-[51] shadow-[0_-4px_20px_rgba(0,0,0,0.12)]" style={{ paddingBottom: "max(12px, env(safe-area-inset-bottom))" }}>
