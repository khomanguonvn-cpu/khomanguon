  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 h-full">
      ...
      <button
        ...
        type="submit"
        className="bg-white p-8 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-5 w-96 md:w-full text-base font-medium leading-4 mt-auto text-gray-900 flex 
      items-center justify-center gap-4 hover:bg-neutral-50 hover:text-black border border-gray-200"
      >
        <Lock />
